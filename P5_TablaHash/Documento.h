...
public:
    ...
    int mostrarTamInexistentes();
    void mostrarInexistentes();
    bool esInexistente(Palabra pal);
    void insertarPalabraDiccionario(Palabra pal);
    void borrarVectorPalabras();
    //////////////OPERADORES///////////////////
...
private:
    ...
    std::list<Palabra> _inexistentes;
};
